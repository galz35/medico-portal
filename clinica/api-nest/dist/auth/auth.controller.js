...
let AuthController = class AuthController {
    ...
    async ssoLogin(token) {
        if (!token)
            throw new common_1.UnauthorizedException('Token de SSO requerido');
        try {
            ...
            if (!user) {
                ...
                throw new common_1.UnauthorizedException('No se pudo establecer sesión con este ticket');
            }
            ...
            throw new common_1.UnauthorizedException('Error interno en autenticación SSO');
        }
    }
};
exports.AuthController = AuthController;
__decorate([
    (0, common_1.Get)('session-portal'),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "checkPortalSession", null);
__decorate([
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Crear usuario ADMIN inicial (Solo si la BD está vacía)' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Reiniciar contraseña (Primer acceso o recuperación)' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Iniciar sesión vía SSO (Portal Central)' }),
